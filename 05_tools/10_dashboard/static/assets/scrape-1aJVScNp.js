import"./index-D3FNW5HD.js";var e=null;async function t(e){if(e.innerHTML=n(),r(e),p(),g(),_(),window._scrapeTab){let t=window._scrapeTab;window._scrapeTab=null;let n=e.querySelector(`.collect-tab[data-tab="`+t+`"]`);n&&n.click()}}function n(){return`
