import{n as e,t}from"./index-CHWtK3Oh.js";import{t as n}from"./account-selector-B-X_KS9a.js";var r=null;async function i(e){let i=(e.id||`interact`).replace(/-/g,`_`),o=await t(`/matrix/accounts`),s=Array.isArray(o)?o:o.accounts||[];e.innerHTML=`
