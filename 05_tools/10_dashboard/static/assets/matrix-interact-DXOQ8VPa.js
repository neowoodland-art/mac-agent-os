import{n as e,t}from"./index-BfayR3mR.js";import{t as n}from"./account-selector-D87mja1n.js";var r=null;async function i(e){let i=(e.id||`interact`).replace(/-/g,`_`),o=await t(`/matrix/accounts`),s=Array.isArray(o)?o:o.accounts||[];e.innerHTML=`
