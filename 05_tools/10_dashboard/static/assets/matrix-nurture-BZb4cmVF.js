import{n as e,t}from"./index-CNXsTUbo.js";import{t as n}from"./account-selector-B-X_KS9a.js";var r=null;async function i(i){let a=i.id||`nurture`,o=await t(`/matrix/accounts`),s=Array.isArray(o)?o:o.accounts||[];i.innerHTML=`
