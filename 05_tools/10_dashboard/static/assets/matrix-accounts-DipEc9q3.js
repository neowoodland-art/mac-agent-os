async function e(e){e.innerHTML=`
    ...
    <div style="display:flex;gap:4px;margin-bottom:12px">
      <div class="acct-tab active" onclick="acctSwitchTab('list',this)" style="padding:6px 12px;cursor:pointer;font-size:12px;border-bottom:2px solid #6366f1;font-weight:600">📋 账号列表</div>
      <div class="acct-tab" onclick="acctSwitchTab('identity',this)" style="padding:6px 12px;cursor:pointer;font-size:12px;color:var(--text2)">🔑 身份管理</div>
    </div>
