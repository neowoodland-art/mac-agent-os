import{n as e,t}from"./index-DZXC4lOk.js";import{t as n}from"./account-selector-DVsh4R5m.js";var r=null;async function i(i){let a=i.id||`nurture`,o=await t(`/matrix/accounts`),s=Array.isArray(o)?o:o.accounts||[];i.innerHTML=`
