...
> ⚠️ 本文件已迁移到根目录 `CONSTITUTION.md`
> **请使用根目录版本**：`~/workbuddy-agent-os/agent-sync/CONSTITUTION.md`
> 同时部署到 `~/.workbuddy/CONSTITUTION.md`
>
...
| **唯一权威源** | 每个信息维度只有一个`01_core/VERSION`/ORACLE.yaml/SKILL_CARD.yaml） |
