...
> 最后更新：2026-05-02 | 版本：3.0 多智能体协同

---

## 一、系统定位

AgentOS 是一套运行在个人 Mac 上的**多智能体协同系统**，核心能力：
- **多机协同**：主节点(master) + 工作节点(maintainer) + 采集节点(node) 分级协作
- **身份驱动**：角色决定权限，所有脚本运行前自动检查
- **全量Git跟踪**：agent-sync/ 全量进 Git，不搞选择性部分跟踪
